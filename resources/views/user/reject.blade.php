...
<head>
    ...
    <title>PT GATE INDONESIA - Request Rejected</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-4">Request Ditolak</h2>
                ...
                <div class="bg-gray-50 p-4 rounded-lg mb-6">
                    <h3 class="font-semibold text-gray-700 mb-2">Detail Request:</h3>
                    <dl class="grid grid-cols-1 gap-3">
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <dt class="text-gray-600">Nomor Container:</dt>
                            <dd class="font-medium text-gray-900">{{ $retrieval->container_number }}</dd>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                            <dt class="text-gray-600">Plat Nomor:</dt>
                            <dd class="font-medium text-gray-900">{{ $retrieval->license_plate }}</dd>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-200">
                        ...
                        <div class="flex justify-between py-2">
                            ...
                            <dd class="font-medium text-gray-900">{{ $retrieval->created_at->format('d M Y, H:i') }}</dd>
                        </div>
                    </dl>
                </div>

    ...
    <div class="container-fluid flex justify-center items-center min-h-screen py-12">
        <div class="bg-white rounded-lg shadow-md p-6 w-96">
            ...
            <div class="text-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Pengambilan Disetujui!</h2>
                <p class="text-gray-600 mt-1">Container siap untuk diambil dari lokasi yang ditentukan</p>
            </div>

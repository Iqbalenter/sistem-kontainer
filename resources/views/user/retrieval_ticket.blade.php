...
<head>
    ...
    <title>Ticket Pengambilan Container - {{ $container_number }}</title>
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl mx-4" style="width: 800px;">
            ...
            <div class="bg-white px-8 py-6 text-gray-900 relative overflow-hidden shadow-lg">
                <div class="relative z-10 flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold mb-1 text-gray-900">RETRIEVAL APPROVAL</h1>
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-blue-600 font-medium text-lg">DISETUJUI UNTUK DIAMBIL</span>
                    </div>
                </div>
            </div>
            ...
            <div class="px-8 py-6">
                ...
                <div class="grid grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold mb-2">Nama Container</p>
                        <p class="font-bold text-blue-600 text-lg">{{ $container_name }}</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-6">
                    <div class="flex items-start">
                        <svg class="h-6 w-6 text-emerald-600 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <div>
                            <p class="text-emerald-800 text-sm font-medium">INFORMASI</p>
                            <p class="text-emerald-700 text-sm mt-1">Tunjukkan tiket ini kepada petugas untuk mengambil container</p>
                        </div>
                    </div>
                </div>

<div class="bg-white rounded-lg shadow-md p-6 w-96">
    ...
    <div class="flex justify-center mb-6">
        <div class="p-4 bg-gray-100 rounded-lg">
            <svg class="h-32 w-32" viewBox="0 0 100 100">
                <!-- Placeholder QR Code, bisa diganti dengan generator QR Code yang sebenarnya -->
    ...
    <div class="mt-6 space-y-3">
        ...
        <a href="{{ route('index') }}" onclick="clearCache(event)" class="block w-full text-center bg-gray-100 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-200 transition duration-200">
    ...
    <!-- JavaScript untuk handling redirect -->
    <script>
        function clearCache(e) {
            // Prevent the default navigation
            e.preventDefault();
            
            // Clear any relevant session storage or local storage if needed
        ...
        // Prevent back button from returning to ticket
